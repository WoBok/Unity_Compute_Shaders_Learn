...
public class BufferJoy : MonoBehaviour
{
    ...
    private void InitData()
    {
        ...
        for (int i = 0; i < total; i++)
        {
            ...
            circle.velocity.x = Random.value * speed - halfSpeed;//速度范围[-halfSpeed,halfSpeed]
    ...
    private void InitShader()
    {
        ...
        circleDataBuffer = new ComputeBuffer(total, stride);
        circleDataBuffer.SetData(circleData);

        shader.SetBuffer(circlesHandle, "circleData", circleDataBuffer);
